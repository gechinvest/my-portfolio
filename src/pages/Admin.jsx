        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border border-gray-400 dark:border-gray-500 bg-white dark:bg-dark-200 text-gray-950 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
              required
            />
            <button
              type="submit"
              ...
              <form onSubmit={handleHeroUpdate} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-gray-400 dark:border-gray-500 bg-white dark:bg-dark-200 text-gray-950 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                    required
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="flex gap-4 items-start">
                    <input
                      ...
                      className="flex-1 px-4 py-2 rounded-lg border border-gray-400 dark:border-gray-500 bg-white dark:bg-dark-200 text-gray-950 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                    />
                  </div>
                    ...
                    <div key={i} className="flex gap-2 items-end">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 rounded border border-gray-400 dark:border-gray-500 bg-white dark:bg-dark-200 text-gray-950 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                        />
                      </div>
                      <div className="flex-1">
